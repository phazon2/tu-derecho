...
Entrada a **Build with Gemini XPRIZE** (xprize.devpost.com) · Categoría **Professional Services Access**.

## Qué hace

1. Subes contrato, finiquito o documento en disputa (pdf o foto) — o lo escribes
...
5. Escribes por WhatsApp, recibes el link de pago de monto fijo ($3.990) y el pack llega por ahí mismo
...
```bash
curl -s "https://tu-derecho.vercel.app/api/health"
